...
Write-Host "  dotnet ef database update --project Backend/src/LogoDesignPortal.Infrastructure --startup-project Backend/src/LogoDesignPortal.API" -ForegroundColor DarkGray
...
Write-Host "See docs/STAGING_DEPLOYMENT_CHECKLIST.md" -ForegroundColor Cyan
