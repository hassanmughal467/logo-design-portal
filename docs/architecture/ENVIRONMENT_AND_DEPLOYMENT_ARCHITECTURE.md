...
| **Staging** | Staging | staging | Not configured | Staging MySQL | `Files_Staging` |
...
flowchart TB
  ...
  subgraph IIS_Staging["IIS — Staging"]
    SPA_S[Not configured<br/>Angular static dist]
    API_S[Not configured<br/>ASP.NET Core 8 API]
  end
