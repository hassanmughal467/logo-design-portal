...
| `Storage__R2__BucketName` | Bucket name | When Provider=R2 | Default: `hawk-files` |
...
Storage__R2__BucketName=hawk-files
```
...
<environmentVariable name="Storage__R2__BucketName" value="hawk-files" />
